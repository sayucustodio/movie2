        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="nav-item d-none d-lg-flex">
                    <a href="/manualdeusuario.pdf" class="btn btn-danger" download="manualMovie.pdf">
                        <span class="btn btn-danger">Descargar Manual</span>
                    </a>
                </li>
            </ol>
        </nav>
                            ...
                            <div class="col-lg-8 pl-lg-5">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="br-wrapper br-theme-css-stars"><select id="profile-rating"
                                                ...
                                                <div class="br-widget"><a href="#" data-rating-value="1"
                                                        ...
                                                        href="#" data-rating-value="5" data-rating-text="5"></a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                ...
                                <div class="profile-feed">
                                    <div class="d-flex align-items-start profile-feed-item">
                                        <img src="img/faces/face13.jpg" alt="profile" class="img-sm rounded-circle">
                                        <div class="ml-4">
                                            <h6>
                                                Mason Beck
                                    ...
                                    <div class="d-flex align-items-start profile-feed-item">
                                        <img src="img/faces/face16.jpg" alt="profile" class="img-sm rounded-circle">
                                        <div class="ml-4">
                                            <h6>
                                                Willie Stanley
                                                <small class="ml-4 text-muted"><i class="far fa-clock mr-1"></i>10
                                    ...
                                    <div class="d-flex align-items-start profile-feed-item">
                                        <img src="img/faces/face19.html" alt="profile" class="img-sm rounded-circle">
                                        <div class="ml-4">
                                            <h6>
                                                Dylan Silva
                                                <small class="ml-4 text-muted"><i class="far fa-clock mr-1"></i>10
