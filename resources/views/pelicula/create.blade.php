    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Registro de Películas</li>
            </ol>
        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('peliculas.store')}}" method="POST" class="form-sample">
                        @csrf
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-check">
                                            ...
                                            <input type="number"
                                                ...
                                                cantidad" value="1" min="1" max="100" required autofocus>
